...
const fetchApi = (id) => {
	...
	.then(data => {
		...
		} else if (url == "http://127.0.0.1:5500/assets/category/chinese/chinese.html") {
			linkText = document.createTextNode("Chinese Dish");
			menuLink.appendChild(linkText);
		} else if (url == "http://127.0.0.1:5500/assets/category/indian/indian.html") {
			linkText = document.createTextNode("Indian Dish");
			menuLink.appendChild(linkText);
		} else if (url == "http://127.0.0.1:5500/assets/category/italian/italian.html") {
			linkText = document.createTextNode("Italian Dish");
			menuLink.appendChild(linkText);
		} else if (url == "http://127.0.0.1:5500/assets/category/japanese/japanese.html") {
